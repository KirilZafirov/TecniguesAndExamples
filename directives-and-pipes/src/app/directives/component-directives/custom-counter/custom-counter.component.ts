...
export class CustomCounterComponent {
  @ContentChild(CounterValueDirective, { static: true, read: TemplateRef }) counterValueTpl: TemplateRef<any>;
  @ContentChild(CounterIncBtnDirective, { static: true, read: TemplateRef }) counterIncBtnTpl: TemplateRef<any>;
  @ContentChild(CounterDecBtnDirective, { static: true, read: TemplateRef }) counterDecBtnTpl: TemplateRef<any>;
